...
const presenters = [
  ...
  { name: "Ian Leigh", image: "/images/presenters/ian-leigh.png", bio: "Ian dreamed of being a radio presenter from an early age, finally realising that ambition in 2006 when he took to the airwaves on Red FM. A club and party DJ since 1984, he kept dancefloors moving for over four decades before retiring from the road in 2025 to devote himself fully to his other great love - radio. Along the way he's built a hugely successful broadcasting career with Essex Link FM, Phoenix FM, Kent's BRFM and Delux Radio, and now reaches listeners around the world on Decades Worldwide Radio." },
